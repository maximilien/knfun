...
func NewE2eTest(t *testing.T, createNamespace bool) *e2eTest {
	return &e2eTest{
		env:             buildEnv(t),
...
func (test *e2eTest) Setup(t *testing.T) {
	...
	test.kubectl = kubectl{t, Logger{}}
	test.funcs = funcs{t, Logger{}}
...
func (test *e2eTest) DeleteTestNamespace(t *testing.T, namespace string) {
	out, err := test.kubectl.RunWithOpts([]string{"delete", "namespace", namespace}, runOpts{})
	if err != nil {
